...
const UpdateEventSection = ({activeEventId}) => {
    ...
    useEffect(() => {
        ...
        async function fetchEventData() {
            try {
                const response = await axios.get(`https://mmx-server.vercel.app/api/events/eventsById/${activeEventId}`, {
                    headers: {
    ...
    useEffect(() => {
        ...
        try {
            const response = await axios.get(`https://mmx-server.vercel.app/api/artists/artistsList`);
